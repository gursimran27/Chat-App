    ...
    <Stack direction='row' justifyContent={el.incoming ? "start" : "end"}>
        ...
        <Stack spacing={2}>
           <Stack p={2} spacing={3} alignItems={'start'} direction={'column'} sx={{
            ...
            <img src={el.preview} alt={el.message} style={{maxHeight:210 , borderRadius:"10px"}} loading='lazy'/>
            <Stack spacing={2}>
  ...
  return (
    <Stack direction='row' justifyContent={el.incoming ? "start" : "end"}>
        ...
        py={1.5} sx={{
            ...
            <Stack spacing={1}>
                <img src={el.img} alt={el.message} loading='lazy' style={{maxHeight:210 , borderRadius:'10px'}}/>
                <Typography variant='body2' color={el.incoming ? theme.palette.text : "#fff"}>
                    {el.message}
                </Typography>
            </Stack>
