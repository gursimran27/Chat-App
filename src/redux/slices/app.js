...
const initialState = {
  ...
  snackbar: {
    open: null,
    severity: null,//can be success,error,warning,info
    message: null,
  },
  ...
  chat_type: null,//[idividualChat,groupChat]
  room_id: null,
  call_logs: [],
};
...
const slice = createSlice({
  ...
  reducers: {
    ...
    closeSnackBar(state) {
      console.log("closeSnackBar is getting executed");
...
export const UpdateUserProfile = ({ firstName, about, avatar, setLoading }) => {
  return async (dispatch, getState) => {
